...
(function() {
  var clear_emails, d, delete_account, handle_get_settings_success, handle_patch_success, populate_emails, populate_orgs, redirect_home, request_get, request_patch, show_ui, update_ui_values;
  ...
  request_get = function(url, success_callback, error_callback) {
    var client;
    client = new XMLHttpRequest();
    client.addEventListener('load', function() {
      if (this.status === 200) {
        return success_callback.call(this);
      } else if (error_callback) {
        return error_callback.call(this);
      }
    });
    if (error_callback) {
      client.addEventListener('error', error_callback);
    }
  ...
  d.addEventListener('DOMContentLoaded', function() {
    ...
    return delete_button.addEventListener('click', delete_account);
  });
